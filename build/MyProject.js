...
// include: C:\Users\korku\AppData\Local\Temp\tmpqvctrj_m.js
...
var REMOTE_PACKAGE_SIZE = metadata['remote_package_size'];
    ...
    loadPackage({"files": [{"filename": "/Frag.shader", "start": 0, "end": 140}, {"filename": "/Vert.shader", "start": 140, "end": 334}], "remote_package_size": 334});

  })();

// end include: C:\Users\korku\AppData\Local\Temp\tmpqvctrj_m.js
// include: C:\Users\korku\AppData\Local\Temp\tmpr1u5_x8u.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if (Module['$ww'] || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: C:\Users\korku\AppData\Local\Temp\tmpr1u5_x8u.js
// include: C:\Users\korku\AppData\Local\Temp\tmpkg3fw_c6.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: C:\Users\korku\AppData\Local\Temp\tmpkg3fw_c6.js
...
function findWasmBinary() {
    return locateFile('MyProject.wasm');
}
...
var _wait = Module['_wait'] = createExportWrapper('wait', 0);
var _runAgain = Module['_runAgain'] = createExportWrapper('runAgain', 0);
var _nfEnd = Module['_nfEnd'] = createExportWrapper('nfEnd', 0);
var _restart = Module['_restart'] = createExportWrapper('restart', 0);
...
if (typeof exports === 'object' && typeof module === 'object') {
  ...
  module.exports.default = CMODULE;
